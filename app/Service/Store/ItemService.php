            ...
            foreach ($itemArray->Item as $item){
                try {
                    Item::updateOrCreate([
                        ...
                        'view_item_url'  =>  $item->ListingDetails->ViewItemURL,
                        'view_item_url_for_natural_search'  =>  $item->ListingDetails->ViewItemURLForNaturalSearch,
                        ...
                        'shipping_service_cost'  =>  $item->ShippingDetails->ShippingServiceOptions->ShippingServiceCost,
                        'shipping_type'  =>  $item->ShippingDetails->ShippingType->GlobalShipping,
